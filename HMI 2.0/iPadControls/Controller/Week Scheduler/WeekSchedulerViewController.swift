...
class WeekSchedulerViewController: UIViewController, UIPopoverPresentationControllerDelegate {
    ...
    @IBAction func weekendButtonPressed(_ sender: UIButton) {
        if !fullScheduleList.isEmpty {
            let weekendPopover = UIStoryboard.init(name: "pumps", bundle: nil).instantiateViewController(withIdentifier: "weekendView") as! WeekendViewController
            ...
            weekendPopover.preferredContentSize = CGSize(width: 440.0, height: 212.0)
