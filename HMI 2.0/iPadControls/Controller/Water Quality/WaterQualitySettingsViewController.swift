//
//  WaterQualitySettingsViewController.swift
//  iPadControls
//
...
class WaterQualitySettingsViewController: UIViewController {
    ...
    @IBAction func redirectToSensorScheduler(_ sender: UIButton) {
        let sensorDetVC = UIStoryboard.init(name: "WQMultiple", bundle: nil).instantiateViewController(withIdentifier: "wqSettings") as! WQSettingsDetailViewController
