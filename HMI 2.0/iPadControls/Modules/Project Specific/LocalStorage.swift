...
public class LocalStorage{
    ...
    private func saveDefaultPumpDetails(){
       ...
       let pumpDetail = PumpDetail.create() as! PumpDetail
        ...
        pumpDetail.voltageMax       = 400
        pumpDetail.voltageMin       = 80
        pumpDetail.maxFrequency     = 60
        
        UserDefaults.standard.set(pumpDetail.pumpNumber, forKey: "defaultPumpNum")
        UserDefaults.standard.set(pumpDetail.currentMax, forKey: "defaultmaxCurrent")
        UserDefaults.standard.set(pumpDetail.maxFrequency, forKey: "defaultmaxFreq")
        UserDefaults.standard.set(pumpDetail.temperatureMax, forKey: "defaultmaxTemp")
        UserDefaults.standard.set(pumpDetail.temperatureMid, forKey: "defaultmidTemp")
        UserDefaults.standard.set(pumpDetail.voltageMax, forKey: "defaultmaxVoltage")
        UserDefaults.standard.set(pumpDetail.voltageMin, forKey: "defaultminVoltage")
