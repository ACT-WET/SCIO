...
-(void)readJSONFile:(int)num{
    ...
    [manager GET:fullpath parameters:nil success:^(AFHTTPRequestOperation *operation, id responseObject){
        ...
        [self populateWeek:_monShows tag:400 yAxis:60 userInteractionEnabled:NO];
        [self populateWeek:_tueShows tag:800 yAxis:120 userInteractionEnabled:NO];
        [self populateWeek:_wedShows tag:1200 yAxis:180 userInteractionEnabled:NO];
        [self populateWeek:_thuShows tag:1600 yAxis:240 userInteractionEnabled:NO];
        [self populateWeek:_friShows tag:2000 yAxis:300 userInteractionEnabled:NO];
        [self populateWeek:_satShows tag:2400 yAxis:360 userInteractionEnabled:NO];
...
-(void)reloadScheduler{
    ...
    [self populateWeek:_monShows tag:400 yAxis:60 userInteractionEnabled:YES];
    [self populateWeek:_tueShows tag:800 yAxis:120 userInteractionEnabled:YES];
    [self populateWeek:_wedShows tag:1200 yAxis:180 userInteractionEnabled:YES];
    [self populateWeek:_thuShows tag:1600 yAxis:240 userInteractionEnabled:YES];
    [self populateWeek:_friShows tag:2000 yAxis:300 userInteractionEnabled:YES];
    [self populateWeek:_satShows tag:2400 yAxis:360 userInteractionEnabled:YES];
